...
int corruptionChecker(char *received_message) {
    ...
    char *state = "true";
    int chekerBitCount=0, commandCount, i, j, messagelength = 0; //Init the counter before you increment it
    int stack = 0;
    ...
    chekerBitCount = chekerBitCount - messagelength;
